...
public class HorizontalLayoutManagerTest {
    ...
    public void should_create_table_empty_table_with_passed_rows_and_cols() {
        ...
        String actualResult = horizontalLayoutManager.createTable(new int[]{10,10,10});
    ...
    public void should_create_empty_table_with_passed_rows_and_columns_and_custom__column_widths() {
        ...
        String actualResult = horizontalLayoutManager.createTable(new int[]{10,20,30});
        String expectedResult=
                        "┌─────────┬───────────────────┬─────────────────────────────┐\n" +
                        "│         │                   │                             │\n" +
                        "├─────────┼───────────────────┼─────────────────────────────┤\n" +
    ...
    public void should_be_able_to_truncate_data_if_data_is_larger_as_compared_to_column_length() {
        LayoutManager horizontalLayoutManager = new HorizontalLayoutManager(3, 3);
